...
function startProgressIndicator(row) {
    row.innerHTML = "<td class='content'>Subiendo archivo... <img height=\"50\" width=\"50\" src=\"images/loading.gif\"></img></td>";
}

function removeProgressIndicator(row) {
    row.innerHTML = "<td class='content'>Subiendo...</td>";
}
...
function uploadFile(node) {
    ...
    if (!file) {
        alert("Archivo no seleccionado para cargar... \t\t\t\t \n\n - Elija un archivo para subir. \n - Then click on Upload button.");
        return;
    }
...
var attachButton = "<br><div class='uploadBox'><input type=\"file\" name=\"file\" id=\"upload_file\"><input width=\"100\" type=\"submit\" value=\"Subir\" onClick='uploadFile(this)'></div>";
...
function showLoadingMessage() {
    document.getElementById('loadingImage').innerHTML = "Cargando imágen " + "<img height=\"100\" width=\"100\" src=\"images/loading.gif\"></img>";
}
